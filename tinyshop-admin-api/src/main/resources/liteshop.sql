...
-- ----------------------------
-- Table structure for `t_shop_address`
-- ----------------------------
...
CREATE TABLE `t_shop_address` (
  ...
  `user_name` varchar(32) DEFAULT NULL COMMENT '收件人',
  PRIMARY KEY (`id`),
  KEY `FK5jm2myqjkxqn1f2uj5bnscaw2` (`create_by`),
  CONSTRAINT `FK5jm2myqjkxqn1f2uj5bnscaw2` FOREIGN KEY (`create_by`) REFERENCES `t_shop_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='收货地址';

-- ----------------------------
-- Records of t_shop_address
-- ----------------------------
INSERT INTO `t_shop_address` VALUES ('1', null, null, null, null, '人民路12号', '北京市', '东城区', '1', null, '15011113333', null, '北京市', '路飞');
INSERT INTO `t_shop_address` VALUES ('2', null, null, null, null, '和平路32号', '深圳市', '福田区', '1', null, '15111112222', null, '上海市', '索隆');
...
CREATE TABLE `t_shop_cart` (
  ...
  `id_user` bigint(20) DEFAULT NULL COMMENT '用户id',
  `specifications` varchar(32) DEFAULT NULL COMMENT '产品规格',
  `count` int(11) DEFAULT NULL COMMENT '数量',
  PRIMARY KEY (`id`),
  KEY `FKsgy9o0r7tt2r61jhc1mfbvfsf` (`create_by`),
  CONSTRAINT `FKsgy9o0r7tt2r61jhc1mfbvfsf` FOREIGN KEY (`create_by`) REFERENCES `t_shop_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='购物车';

-- ----------------------------
-- Records of t_shop_cart
-- ----------------------------
INSERT INTO `t_shop_cart` VALUES ('4', null, '2019-11-07 15:20:11', null, '2019-11-07 15:20:11', '3', '1', null, '1');
INSERT INTO `t_shop_cart` VALUES ('5', null, '2019-11-07 15:33:41', null, '2019-11-07 15:33:41', '6', '1', null, '2');
INSERT INTO `t_shop_cart` VALUES ('6', null, '2019-11-07 15:35:01', '1', '2019-11-07 17:36:21', '1', '1', null, '2');
...
CREATE TABLE `t_shop_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKoqg6rd96sjixe25t5qyj6d9d3` (`create_by`),
  CONSTRAINT `FKoqg6rd96sjixe25t5qyj6d9d3` FOREIGN KEY (`create_by`) REFERENCES `t_shop_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='商品类别';

-- ----------------------------
-- Records of t_shop_category
-- ----------------------------
INSERT INTO `t_shop_category` VALUES ('1', null, null, null, null, '', '日用杂品', '');
INSERT INTO `t_shop_category` VALUES ('2', null, null, null, null, '', '水果生鲜', '');
INSERT INTO `t_shop_category` VALUES ('3', null, null, null, null, '', '干果零食', '');
INSERT INTO `t_shop_category` VALUES ('4', null, null, null, null, '', '家用五金', '');
...
-- ----------------------------
INSERT INTO `t_shop_goods` VALUES ('1', null, null, null, null, '<div id=\"desc\" class=\"of\"><div class=\"product-detail-html\"><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123421566.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712168682425.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123477712.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123576380.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589514.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123575919.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123582135.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574449.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583750.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577476.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583289.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123573526.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589612.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712167949956.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123594262.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577049.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579387.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574821.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123578170.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579123.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123572118.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577193.png!60\"></a></div> </div><div><div><a href=\"https://t.flowerplus.cn/#link_cate_13\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577505.png!60\"></a></div> </div> </div></div>', '1,2,3', '1', '星冰乐咖啡', '2', null, '100', '1000', '好喝的咖啡，让你喝了一杯还想再喝一杯');
INSERT INTO `t_shop_goods` VALUES ('2', null, null, null, null, '<div id=\"desc\" class=\"of\"><div class=\"product-detail-html\"><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123421566.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712168682425.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123477712.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123576380.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589514.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123575919.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123582135.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574449.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583750.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577476.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583289.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123573526.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589612.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712167949956.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123594262.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577049.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579387.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574821.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123578170.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579123.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123572118.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577193.png!60\"></a></div> </div><div><div><a href=\"https://t.flowerplus.cn/#link_cate_13\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577505.png!60\"></a></div> </div> </div></div>', '1,2,3', '1', '时尚T恤', '1', null, '150', '8400', '好看的T恤，最舒服的材质，没精美的做工，绝对让你爽歪歪');
INSERT INTO `t_shop_goods` VALUES ('3', null, null, null, null, '<div id=\"desc\" class=\"of\"><div class=\"product-detail-html\"><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123421566.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712168682425.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123477712.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123576380.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589514.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123575919.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123582135.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574449.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583750.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577476.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583289.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123573526.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589612.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712167949956.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123594262.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577049.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579387.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574821.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123578170.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579123.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123572118.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577193.png!60\"></a></div> </div><div><div><a href=\"https://t.flowerplus.cn/#link_cate_13\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577505.png!60\"></a></div> </div> </div></div>', '1,2,3', '2', '摩卡咖啡', '3', null, '111', '3200', '好喝的咖啡，让你喝了一杯还想再喝一杯');
INSERT INTO `t_shop_goods` VALUES ('4', null, null, null, null, '<div id=\"desc\" class=\"of\"><div class=\"product-detail-html\"><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123421566.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712168682425.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123477712.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123576380.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589514.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123575919.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123582135.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574449.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583750.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577476.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583289.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123573526.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589612.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712167949956.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123594262.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577049.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579387.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574821.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123578170.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579123.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123572118.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577193.png!60\"></a></div> </div><div><div><a href=\"https://t.flowerplus.cn/#link_cate_13\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577505.png!60\"></a></div> </div> </div></div>', '1,2,3', '2', '美式咖啡', '1', null, '121', '2800', '好喝的咖啡');
INSERT INTO `t_shop_goods` VALUES ('5', null, null, null, null, '<div id=\"desc\" class=\"of\"><div class=\"product-detail-html\"><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123421566.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712168682425.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123477712.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123576380.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589514.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123575919.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123582135.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574449.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583750.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577476.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583289.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123573526.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589612.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712167949956.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123594262.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577049.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579387.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574821.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123578170.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579123.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123572118.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577193.png!60\"></a></div> </div><div><div><a href=\"https://t.flowerplus.cn/#link_cate_13\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577505.png!60\"></a></div> </div> </div></div>', '1,2,3', '3', '星冰乐咖啡', '2', null, '131', '1000', '好喝的咖啡，让你喝了一杯还想再喝一杯');
INSERT INTO `t_shop_goods` VALUES ('6', null, null, null, null, '<div id=\"desc\" class=\"of\"><div class=\"product-detail-html\"><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123421566.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712168682425.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123477712.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123576380.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589514.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123575919.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123582135.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574449.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583750.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577476.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123583289.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123573526.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123589612.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-16/15712167949956.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123594262.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577049.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579387.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123574821.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123578170.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123579123.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123572118.png!60\"></a></div> </div><div><div><a href=\"javascript:;\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577193.png!60\"></a></div> </div><div><div><a href=\"https://t.flowerplus.cn/#link_cate_13\"><img src=\"https://oss.flowerplus.cn/oss_png/2019-10-15/15711123577505.png!60\"></a></div> </div> </div></div>', '1,2,3', '3', '时尚T恤', '1', null, '141', '8400', '好看的T恤，最舒服的材质，没精美的做工，绝对让你爽歪歪');
...
CREATE TABLE `t_shop_order` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKr8ldcrj2onq8l8w61724jruvq` (`create_by`),
  CONSTRAINT `FKr8ldcrj2onq8l8w61724jruvq` FOREIGN KEY (`create_by`) REFERENCES `t_shop_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='订单';

-- ----------------------------
-- Records of t_shop_order
-- ----------------------------
INSERT INTO `t_shop_order` VALUES ('1', '1', '2019-11-06 17:58:40', '1', '2019-11-06 17:58:50', null, '1', '1', null, 'OSN2019110605371201', '10400', '1', '10400');
INSERT INTO `t_shop_order` VALUES ('2', '1', '2019-11-06 17:58:40', '1', '2019-11-06 17:58:50', null, '2', '1', null, 'OSN2019110605371202', '8800', '2', '8800');
...
CREATE TABLE `t_shop_order_item` (
  ...
  `modify_by` bigint(20) DEFAULT NULL COMMENT '最后更新人',
  `modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  `amount` varchar(16) DEFAULT NULL COMMENT '数量',
  `id_goods` bigint(20) DEFAULT NULL COMMENT '商品id',
  `id_order` bigint(20) DEFAULT NULL COMMENT '所属订单id',
  `price` varchar(16) DEFAULT NULL COMMENT '单价',
  `total_price` varchar(16) DEFAULT NULL COMMENT '合计',
  PRIMARY KEY (`id`),
  KEY `FKn5ru54aq1tqhivaipuj97e43s` (`create_by`),
  CONSTRAINT `FKn5ru54aq1tqhivaipuj97e43s` FOREIGN KEY (`create_by`) REFERENCES `t_shop_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='订单明细';

-- ----------------------------
-- Records of t_shop_order_item
-- ----------------------------
INSERT INTO `t_shop_order_item` VALUES ('1', '1', '2019-11-06 17:58:56', '1', '2019-11-06 17:59:01', '2', '1', '1', '1000', '2000');
INSERT INTO `t_shop_order_item` VALUES ('2', '1', '2019-11-06 17:58:56', '1', '2019-11-06 17:59:01', '1', '2', '1', '8400', '8400');
INSERT INTO `t_shop_order_item` VALUES ('3', '1', '2019-11-06 17:58:56', '1', '2019-11-06 17:59:01', '1', '3', '2', '3200', '3200');
INSERT INTO `t_shop_order_item` VALUES ('4', '1', '2019-11-06 17:58:56', '1', '2019-11-06 17:59:01', '2', '4', '2', '2800', '5600');
...
CREATE TABLE `t_shop_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `avatar` varchar(16) DEFAULT NULL COMMENT '头像',
...
-- ----------------------------
INSERT INTO `t_shop_user` VALUES ('1', null, null, '15011112222', 'enilu', 'b5a51391f271f062867e5984e2fcffee', '8pgby');
...
-- ----------------------------
INSERT INTO `t_sys_cfg` VALUES ('1', null, null, '-1', '2019-11-05 19:30:00', 'update by 2019-11-05 19:30:00', 'system.app.name', 'web-flash');
INSERT INTO `t_sys_cfg` VALUES ('2', null, null, '1', '2019-04-15 21:36:17', '系统默认上传文件路径', 'system.file.upload.path', '/data/lite-shop/runtime/upload');
...
-- ----------------------------
INSERT INTO `t_sys_file_info` VALUES ('1', '1', '2019-03-18 10:34:34', '1', '2019-03-18 10:34:34', 't-shiirt.jpg', '7e9ebc08-b194-4f85-8997-d97ccb0d2c2d.png');
INSERT INTO `t_sys_file_info` VALUES ('2', '1', '2019-03-18 10:54:04', '1', '2019-03-18 10:54:04', 'banner2.png', '7143c463-8c37-4e24-a6c9-3150f7a7dae9.jpg');
INSERT INTO `t_sys_file_info` VALUES ('3', '1', '2019-03-18 20:09:59', '1', '2019-03-18 20:09:59', 'offcial_site.png', 'b651cfeb-ce41-452a-87ff-e2706880af63.jpg');
...
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8 COMMENT='菜单';

-- ----------------------------
-- Records of t_sys_menu
-- ----------------------------
INSERT INTO `t_sys_menu` VALUES ('1', '1', '2019-07-31 22:04:30', '1', '2019-11-04 17:09:34', 'system', 'layout', '0', 'system', '1', null, '1', '系统管理', '2', '0', '[0],', '1', null, '/system');
...
INSERT INTO `t_sys_menu` VALUES ('71', null, null, '1', '2019-11-04 17:09:29', 'shopMgr', 'layout', '0', 'shop', '1', null, '1', '商城管理', '1', '0', '[0],', '1', null, '/shop');
INSERT INTO `t_sys_menu` VALUES ('72', null, null, '1', '2019-11-04 17:06:54', 'shopUser', 'views/shop/shopUser/index', '0', 'user', '1', null, '2', '用户管理', '1', 'shopMgr', '[0],[shopMgr],', '1', null, '/shopUser');
INSERT INTO `t_sys_menu` VALUES ('73', '1', '2019-11-04 19:01:20', '1', '2019-11-04 19:01:20', 'goods', 'views/shop/goods/index', '0', 'goods', '1', null, '2', '商品管理', '2', 'shopMgr', '[0],[shopMgr],', '1', null, '/goods');
INSERT INTO `t_sys_menu` VALUES ('74', '1', '2019-11-04 19:07:13', '1', '2019-11-04 19:07:13', 'order', 'views/shop/order/index', '0', 'order', '1', null, '2', '订单管理', '3', 'shopMgr', '[0],[shopMgr],', '1', null, '/order');
INSERT INTO `t_sys_menu` VALUES ('75', null, null, '1', '2019-11-04 19:10:44', 'category', 'views/shop/category/index', '0', 'category', '1', null, '2', '商品类别', '1', 'shopMgr', '[0],[shopMgr],', '1', null, '/category');
INSERT INTO `t_sys_menu` VALUES ('76', '1', '2019-11-04 19:08:51', '1', '2019-11-04 19:08:51', 'cart', 'views/shop/cart/index', '0', 'cart', '1', null, '2', '购物车', '4', 'shopMgr', '[0],[shopMgr],', '1', null, '/cart');
...
CREATE TABLE `t_sys_operation_log` (
  ...
  `userid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='操作日志';
...
CREATE TABLE `t_sys_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=292 DEFAULT CHARSET=utf8 COMMENT='菜单角色关系';
...
INSERT INTO `t_sys_relation` VALUES ('216', '1', '1');
INSERT INTO `t_sys_relation` VALUES ('217', '4', '1');
INSERT INTO `t_sys_relation` VALUES ('218', '5', '1');
INSERT INTO `t_sys_relation` VALUES ('219', '6', '1');
INSERT INTO `t_sys_relation` VALUES ('220', '7', '1');
INSERT INTO `t_sys_relation` VALUES ('221', '8', '1');
INSERT INTO `t_sys_relation` VALUES ('222', '9', '1');
INSERT INTO `t_sys_relation` VALUES ('223', '10', '1');
INSERT INTO `t_sys_relation` VALUES ('224', '11', '1');
INSERT INTO `t_sys_relation` VALUES ('225', '12', '1');
INSERT INTO `t_sys_relation` VALUES ('226', '13', '1');
INSERT INTO `t_sys_relation` VALUES ('227', '14', '1');
INSERT INTO `t_sys_relation` VALUES ('228', '15', '1');
INSERT INTO `t_sys_relation` VALUES ('229', '16', '1');
INSERT INTO `t_sys_relation` VALUES ('230', '17', '1');
INSERT INTO `t_sys_relation` VALUES ('231', '18', '1');
INSERT INTO `t_sys_relation` VALUES ('232', '19', '1');
INSERT INTO `t_sys_relation` VALUES ('233', '20', '1');
INSERT INTO `t_sys_relation` VALUES ('234', '21', '1');
INSERT INTO `t_sys_relation` VALUES ('235', '23', '1');
INSERT INTO `t_sys_relation` VALUES ('236', '24', '1');
INSERT INTO `t_sys_relation` VALUES ('237', '28', '1');
INSERT INTO `t_sys_relation` VALUES ('238', '29', '1');
INSERT INTO `t_sys_relation` VALUES ('239', '32', '1');
INSERT INTO `t_sys_relation` VALUES ('240', '22', '1');
INSERT INTO `t_sys_relation` VALUES ('241', '25', '1');
INSERT INTO `t_sys_relation` VALUES ('242', '26', '1');
INSERT INTO `t_sys_relation` VALUES ('243', '27', '1');
INSERT INTO `t_sys_relation` VALUES ('244', '30', '1');
INSERT INTO `t_sys_relation` VALUES ('245', '31', '1');
INSERT INTO `t_sys_relation` VALUES ('246', '33', '1');
INSERT INTO `t_sys_relation` VALUES ('247', '34', '1');
INSERT INTO `t_sys_relation` VALUES ('248', '35', '1');
INSERT INTO `t_sys_relation` VALUES ('249', '36', '1');
INSERT INTO `t_sys_relation` VALUES ('250', '37', '1');
INSERT INTO `t_sys_relation` VALUES ('251', '38', '1');
INSERT INTO `t_sys_relation` VALUES ('252', '39', '1');
INSERT INTO `t_sys_relation` VALUES ('253', '40', '1');
INSERT INTO `t_sys_relation` VALUES ('254', '47', '1');
INSERT INTO `t_sys_relation` VALUES ('255', '2', '1');
INSERT INTO `t_sys_relation` VALUES ('256', '41', '1');
INSERT INTO `t_sys_relation` VALUES ('257', '68', '1');
INSERT INTO `t_sys_relation` VALUES ('258', '69', '1');
INSERT INTO `t_sys_relation` VALUES ('259', '42', '1');
INSERT INTO `t_sys_relation` VALUES ('260', '70', '1');
INSERT INTO `t_sys_relation` VALUES ('261', '43', '1');
INSERT INTO `t_sys_relation` VALUES ('262', '66', '1');
INSERT INTO `t_sys_relation` VALUES ('263', '67', '1');
INSERT INTO `t_sys_relation` VALUES ('264', '44', '1');
INSERT INTO `t_sys_relation` VALUES ('265', '45', '1');
INSERT INTO `t_sys_relation` VALUES ('266', '65', '1');
INSERT INTO `t_sys_relation` VALUES ('267', '46', '1');
INSERT INTO `t_sys_relation` VALUES ('268', '3', '1');
INSERT INTO `t_sys_relation` VALUES ('269', '48', '1');
INSERT INTO `t_sys_relation` VALUES ('270', '50', '1');
INSERT INTO `t_sys_relation` VALUES ('271', '51', '1');
INSERT INTO `t_sys_relation` VALUES ('272', '49', '1');
INSERT INTO `t_sys_relation` VALUES ('273', '52', '1');
INSERT INTO `t_sys_relation` VALUES ('274', '53', '1');
INSERT INTO `t_sys_relation` VALUES ('275', '54', '1');
INSERT INTO `t_sys_relation` VALUES ('276', '55', '1');
INSERT INTO `t_sys_relation` VALUES ('277', '56', '1');
INSERT INTO `t_sys_relation` VALUES ('278', '57', '1');
INSERT INTO `t_sys_relation` VALUES ('279', '58', '1');
INSERT INTO `t_sys_relation` VALUES ('280', '61', '1');
INSERT INTO `t_sys_relation` VALUES ('281', '62', '1');
INSERT INTO `t_sys_relation` VALUES ('282', '59', '1');
INSERT INTO `t_sys_relation` VALUES ('283', '63', '1');
INSERT INTO `t_sys_relation` VALUES ('284', '64', '1');
INSERT INTO `t_sys_relation` VALUES ('285', '60', '1');
INSERT INTO `t_sys_relation` VALUES ('286', '71', '1');
INSERT INTO `t_sys_relation` VALUES ('287', '72', '1');
INSERT INTO `t_sys_relation` VALUES ('288', '73', '1');
INSERT INTO `t_sys_relation` VALUES ('289', '74', '1');
INSERT INTO `t_sys_relation` VALUES ('290', '75', '1');
INSERT INTO `t_sys_relation` VALUES ('291', '76', '1');
...
-- ----------------------------
INSERT INTO `t_sys_task` VALUES ('1', '1', '2018-12-28 09:54:00', '-1', '2019-11-05 19:30:00', '0', '0 0/30 * * * ?', '{\n\"appname\": \"web-flash\",\n\"version\":1\n}\n            \n            \n            \n            \n            \n            \n            \n            \n            \n            \n            \n            ', '0', '2019-11-05 19:30:00', '执行成功', 'cn.enilu.flash.service.task.job.HelloJob', 'default', '测试任务', '测试任务,每30分钟执行一次');
